  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <Image 
          src="/primeland-logo.png"
          alt="logo"
          width={80}
          height={70}
          className="absolute left-[-5px] top-[-20px] w-10 lg:w-[100px]"
        />
        <h2 className="bold-52 lg:bold-88">PRIMELAND MARK</h2>
<h3>We work with a purpose and the purpose is to create value for everyone.</h3>
...
Our commitment to our customers has been at the core of what we do and have always placed a premium on a collaborative and a “win-win” relationship’s.
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 flex w-[240px] flex-col gap-5 rounded-3xl bg-green-90 px-5 py-6">
           ...
           <div className="flex flex-col">
            ...
            <p className="bold-10 text-white">My Home Hub, 7th Floor, Block 2</p>
          </div>

          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular-12 block text-gray-20">Hitechcity Hyderabad,</p>
              <p className="bold-10 text-white">Telangana 500033</p>
            </div>
